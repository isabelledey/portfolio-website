  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-[60] flex flex-col h-full w-80 border-r border-white/10 bg-neutral-950/90 backdrop-blur-2xl shadow-2xl shadow-violet-900/20 divide-y divide-white/5 hidden lg:flex">
      <div className="px-6 py-12 flex flex-col items-start">
        ...
        <p className="text-neutral-500 text-sm">Atmospheric Intelligence</p>
      </div>
      <nav className="flex-1 py-8 text-sm font-medium">
        <a className="flex items-center gap-4 bg-violet-500/10 text-violet-400 border-r-4 border-violet-500 px-6 py-4 transition-all duration-200" href="#intro">
          <span className="material-symbols-outlined">dashboard</span> Intro
        </a>
        <a className="flex items-center gap-4 text-neutral-500 px-6 py-4 hover:bg-white/5 hover:text-white transition-all duration-200" href="#expertise">
          <span className="material-symbols-outlined">psychology</span> Expertise
        </a>
        <a className="flex items-center gap-4 text-neutral-500 px-6 py-4 hover:bg-white/5 hover:text-white transition-all duration-200" href="#artifacts">
          <span className="material-symbols-outlined">deployed_code</span> Artifacts
        </a>
        <a className="flex items-center gap-4 text-neutral-500 px-6 py-4 hover:bg-white/5 hover:text-white transition-all duration-200" href="#timeline">
